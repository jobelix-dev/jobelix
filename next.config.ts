        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              `connect-src 'self' https://api.stripe.com https://api.github.com https://api.openai.com wss://127.0.0.1:54321 https://vitals.vercel-insights.com https://va.vercel-scripts.com ${process.env.NEXT_PUBLIC_SUPABASE_URL}`,
