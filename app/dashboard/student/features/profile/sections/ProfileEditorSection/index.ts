/**
 * ProfileEditorSection - Barrel Export
 */
...
// Also export as named exports for easier re-exporting
export { default as ProfileEditorSection } from './ProfileEditorSection';
