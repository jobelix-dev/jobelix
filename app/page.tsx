    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-surface">
      <main className="max-w-6xl mx-auto px-6 py-12 md:py-20">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-bold text-default mb-6">
            Automate Your Job Search
            <span className="block mt-2 bg-gradient-to-r from-primary to-info bg-clip-text text-transparent">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
            <Link
              href="/download"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-primary hover:bg-primary-hover text-white text-lg font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all"
            >
            ...
            <Link
              ...
              className="inline-flex items-center justify-center px-8 py-4 bg-primary hover:bg-primary-hover text-white text-primary text-lg font-semibold rounded-lg transition-all"
            >
              Sign Up for Web
            </Link>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="text-center">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-primary-subtle/40 rounded-2xl mb-4">
          ...
          <div className="text-center">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-info/40 rounded-2xl mb-4">
          ...
          <div className="text-center">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-success/40 rounded-2xl mb-4">
        ...
        {/* How It Works */}
        <div className="bg-gradient-to-r from-primary-subtle to-info-subtle/20/20 border border-primary-subtle rounded-2xl p-8 md:p-12">
          <h2 className="text-3xl font-bold text-default text-center mb-8">
            How Jobelix Works
          </h2>
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="w-12 h-12 bg-primary text-white font-bold rounded-full flex items-center justify-center mx-auto mb-3">
                1
              </div>
              <h4 className="font-semibold text-default mb-2">Download & Sign Up</h4>
              <p className="text-sm text-muted">
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-default mb-2">Upload Resume</h4>
              <p className="text-sm text-muted">
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-default mb-2">Launch Bot</h4>
              <p className="text-sm text-muted">
