-- ============================================================================
-- Migration: Analytics Daily Snapshot View
-- Description: Creates a view that aggregates growth and engagement metrics
--              by day for the dashboard. Includes cumulative counts using
--              window functions for efficient charting.
-- ============================================================================

-- =============================================================================
-- VIEW: analytics_daily_snapshot
-- =============================================================================
...
REVOKE ALL ON public.analytics_daily_snapshot FROM PUBLIC;
REVOKE ALL ON public.analytics_daily_snapshot FROM authenticated;
REVOKE ALL ON public.analytics_daily_snapshot FROM anon;

GRANT SELECT ON public.analytics_daily_snapshot TO service_role;
