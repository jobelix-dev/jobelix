 ...
 * 
 * Templates for the 4-stage resume tailoring pipeline:
 * 1. Keyword extraction from job description
 * 2. Resume item scoring by relevance
 * 3. (Filtering is done in code, no prompt needed)
 * 4. Keyword optimization in filtered resume
 * 
 * Also includes the legacy single-prompt tailoring method.
 */
...
/** Extract key terms from job description for ATS optimization */
...
/** Score all resume items by relevance to job description */
...
// ============================================================================
// STAGE 4: KEYWORD OPTIMIZATION
// ============================================================================

/** Optimize filtered resume descriptions with job keywords */
...
// ============================================================================
// LEGACY: SINGLE-PROMPT TAILORING (fallback only)
// ============================================================================

/** Legacy single-prompt resume tailoring - used as fallback if pipeline fails */
