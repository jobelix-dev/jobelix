const numericQuestionTemplate = `The following is a resume and an answered question about the resume, being answered by the person who's resume it is (first person).
...
## `;
const personalInformationTemplate = `Answer the following question based on the provided personal information and experience.
...
Question: {question}
`;
const selfIdentificationTemplate = `Answer the following question based on the provided self-identification details.
...
Question: {question}`;
const legalAuthorizationTemplate = `Answer the following question based on the provided legal authorization details.
...
Question: {question}`;
const workPreferencesTemplate = `Answer the following question based on the provided work preferences.
...
Question: {question}`;
const educationDetailsTemplate = `Answer the following question based on the provided education details.
...
Question: {question}`;
const experienceDetailsTemplate = `Answer the following question based on the provided work experience.
...
Question: {question}`;
const projectsTemplate = `Answer the following question based on the provided project information.
...
Question: {question}`;
const availabilityTemplate = `Answer the following question based on the provided availability information.
...
Question: {question}`;
const salaryExpectationsTemplate = `Answer the following question based on the provided salary expectations.
...
Question: {question}`;
const certificationsTemplate = `Answer the following question based on the provided certifications.
...
Question: {question}`;
const languagesTemplate = `Answer the following question based on the provided language skills.
...
Question: {question}`;
const interestsTemplate = `Answer the following question about career interests and motivations.
...
Question: {question}`;
const coverLetterTemplate = `You are a professional career advisor and expert cover letter writer. Write a compelling, personalized cover letter based on the candidate's resume and the job description.
...
- DO NOT use overly generic phrases or clich\xE9s
...
## Cover Letter:
`;
const optionsTemplate = `The following is a resume and an answered question about the resume, the answer is one of the options.
